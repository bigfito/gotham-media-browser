...
**Last updated:** 2026-09-07T13:20:00Z  
**Active phase:** P0  
**Prototype status:** `in_progress`  
**Next task:** `P0-T03` (Agent entrypoints — no deps) or `P0-T04` (shared Thymeleaf layout — dep P0-T01 done)
...
|-------|-------|------------|--------|
| P0 | Scaffold & agent harness | 2/5 | in_progress |
